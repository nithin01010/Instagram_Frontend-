    ...
    return (
        ...
        <div className="h-screen w-full bg-black overflow-y-scroll snap-y snap-mandatory flex flex-col items-center pb-[60px] md:pb-0">
                    ...
                    >
                        ...
                        <div className="absolute top-0 left-0 w-full p-4 flex items-center gap-3 z-10 bg-gradient-to-b from-black/80 to-transparent">
                            <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-700">
                                <ProfileAvatar userId={post.user_id} />
                            </div>
                            <span className="text-white font-semibold text-sm tracking-wide">
                                {post.user_id || "Instagram User"}
                            </span>
                        </div>
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-4 pb-6 z-10 bg-gradient-to-t from-black/90 via-black/50 to-transparent flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-4 text-white">
                                <button onClick={handleLike} className="hover:text-gray-300 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                                      <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                                    </svg>
                                </button>
                                <button onClick={handleComment} className="hover:text-gray-300 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                            ...
                            <div className="text-white text-sm">
                                <span className="font-semibold mr-2">{post.user_id || "User"}</span>
            ...
            {!isLoading && posts.length === 0 && (
                <div ref={lastElementRef} className="h-10 w-full flex items-center justify-center text-white text-sm">
